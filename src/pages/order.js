...
const OrderPage = () => (
  <Layout>
    ...
    <p>
      You can get started with just one, but Hiome works better with more sensors. To make your lights follow you from room to room,
      you'll need a Hiome Door sensor on every door.
    </p>
